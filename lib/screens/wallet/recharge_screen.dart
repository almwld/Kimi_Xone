...
class _RechargeScreenState extends State<RechargeScreen> {
  ...
  final List<double> _amounts = [500, 1000, 2000, 5000, 10000, 20000];
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            SizedBox(height: 10),
            Text(
              'تم شحن ${_selectedAmount.toStringAsFixed(0)} ر.ي',
              style: TextStyle(
                fontFamily: 'Tajawal',
                fontSize: 16,
                color: Colors.grey,
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                children: [
                  _buildSummaryRow('المبلغ', '${_selectedAmount.toStringAsFixed(0)} ر.ي'),
                  Divider(height: 16),
                  _buildSummaryRow('الرسوم', '0 ر.ي'),
                  Divider(height: 16),
                  _buildSummaryRow('الإجمالي', '${_selectedAmount.toStringAsFixed(0)} ر.ي', isTotal: true),
                ],
              ),
            ),
      ...
      children: [
        ...
        Text(
          ...
          style: TextStyle(
            ...
            fontWeight: FontWeight.bold,
            color: isTotal ? AppTheme.goldPrimary : (Theme.of(context).brightness == Brightness.dark ? Colors.white : AppTheme.lightText),
          ),
        ),
      ],
    );
